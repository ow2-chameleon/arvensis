...
[Protocol and implemented capabilities]
...
[JSON-RPC-(import-export)]: ../JSON-RPC-(import-export).html
[JAX-RS-(export-only)]: ../JAX-RS-(export-only).html
[XML-RPC-(import-export)]: ../XML-RPC-(import-export).html
[JAX-WS-(import-export)]: ../JAX-WS-(import-export).html
